...
public class AbdmEncryption {
    ...
    public com.had.project5.common.EncryptionResponse encrypt(com.had.project5.common.EncryptionRequest encryptionRequest) throws Exception {
        ...
        return new com.had.project5.common.EncryptionResponse(encryptedData, keyToShare);
    }
