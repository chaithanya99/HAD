...
const Step4 = ({ mobileNumber, otpSize, retryTime, token, step, setStep, txnId }) => {
  ...
  return (
    ...
    >
      <FormHeader
        ...
        description={`Enter the OTP sent to your Mobile Number to verify your Aadhar Number.`}
      />
      <Form.Group controlId="mobile_display">
        <Form.ControlLabel>Your Mobile Number is:</Form.ControlLabel>
        <div style={{ fontWeight: 'bold', fontSize: '18px', marginBottom: '10px' }}>{mobileNumber}</div>
      </Form.Group>
